  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved reading as @reading" do
        ...
        post :create, {:reading => { "name" => "invalid value" }}, valid_session
        assigns(:reading).should be_a_new(Reading)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested reading" do
        ...
        Reading.any_instance.should_receive(:update).with({ "name" => "MyString" })
        put :update, {:id => reading.to_param, :reading => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the reading as @reading" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Reading.any_instance.stub(:save).and_return(false)
        put :update, {:id => reading.to_param, :reading => { "name" => "invalid value" }}, valid_session
        assigns(:reading).should eq(reading)
      end
